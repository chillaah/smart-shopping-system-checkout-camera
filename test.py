...
# output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()] for RPi - architecture issues
...
while True:
    ...
    # Detecting objects
    blob = cv2.dnn.blobFromImage(frame, 0.00392, (416, 416), (0, 0, 0), True, crop=False) # 1/255 = 0.00392
